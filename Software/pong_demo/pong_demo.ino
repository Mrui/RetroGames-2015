...
/*
 * TODO:
 * - Fix buttons and joystick (movement is not predictable or accurate)
 * - Add scoreboard (setStr helps here)
 * - Add "hitboxes" for the pads as atm the ball just goes through them.
 *
 * Extra features:
 * - AI player. Thats it, it is a pong game,there's really not too much to do here.
 * Check definitions.h for more information.
 */
...
// You can add the check for collision with a paddle in this function or make a new one for it.
void moveBall()
{
